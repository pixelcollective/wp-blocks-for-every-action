...
registerBlockType( 'tpc/every-action-advocacy-form', {
	title: __( 'Advocacy Form' ),
	icon: 'megaphone',
    ...
    const { attributes, setAttributes } = props;
      ...
      { ! attributes.formURL &&
        ...
        <fieldset disabled>
          ...
          <button className={ 'button is-disabled disabled' }>Submit</button>
        </fieldset>
        <div className={ attributes.className }>
        <InspectorControls>
          <PanelBody>
            <TextControl
            label={__('Advocacy Form URL')}
